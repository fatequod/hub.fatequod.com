...
const DocumentView = () => {
  const { category, subcategory, filename } = useParams();
  ...
  useEffect(() => {
    const fetchDocument = async () => {
      try {
        ...
        const path = `${category}/${subcategory}/${filename}`;
        const response = await axios.get(`/api/documents/${category}/${subcategory}/${filename}`);
  ...
  if (loading) return <div className="document-container">Loading document...</div>;
  ...
  return (
    <div className="main-content">
        ...
        <div className="document-header">
          <div className="document-breadcrumbs">
            ...
            {subcategory && (
              <>
                <span className="separator">/</span>
                <span className="folder">{subcategory}</span>
              </>
            )}
            <span className="separator">/</span>
          ...
          <div className="document-meta">
            {docData.lastModified && (
              <span>
                ...
                Last updated: {new Date(docData.lastModified).toLocaleDateString()}
              </span>
            )}
            {docData.author && (
              <span>
      ...
      <PageNavigation documentContent={docData.content} />
    </div>
  );
};
